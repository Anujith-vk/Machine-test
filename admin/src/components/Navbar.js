...
const Navbar = () => {
  ...
  const handleReservation = () => navigate('/reservations');
    ...
    <div className="flex justify-between items-center relative bg-black sm:h-[40px] md:h-[100px] w-full md:px-8">
      ...
      <div className="hidden md:flex space-x-12 text-white text-sm mt-12">
        <ul className="flex gap-12">
          ...
          <li onClick={handleAdd} className="cursor-pointer font-[Oswald] text-[16px] text-[#F5F5F5]">ADD ITEMS</li>
          <li onClick={handleReservation} className="cursor-pointer font-[Oswald] text-[16px] text-[#F5F5F5]">RESERVATIONS</li>
        </ul>
      </div>
